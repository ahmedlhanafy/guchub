      ...
      <Screen.Content>
        <Container>
          ...
          <TouchableOpacity onPress={() => Linking.openURL('https://github.com/ahmedlhanafy')}>
            <GithubIcon
              source={{
                uri: 'https://user-images.githubusercontent.com/11808903/38215477-4d4e2c68-36c8-11e8-8240-73779aaab9c1.png',
              }}
            />
          </TouchableOpacity>
          <Seperator />
          ...
          <Text center={false}>
            We assume no responsibility or liability for any loss or damage suffered by any person
            as a result of the use or misuse of any of the information or content on this app. We
            assume or undertake <Bold>NO LIABILITY</Bold> for any loss or damage suffered as a
            result of the use, misuse or reliance on the information and content on this app.
          </Text>
          <Seperator />
          <Text center={false}>
